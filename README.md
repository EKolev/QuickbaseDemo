...
QuickbaseDemo is a solution written for the take home assignment from Quickbase. It provides implementations for both static and dynamic tables, querying on exact match, indexing.
